...
void squares(int size1, int x_offset, int y_offset, int size2) {
  int h;
  int w;
  w=(int) max(size1, x_offset +size2); //compute the max of size1 and (x_offset + size2).  Call this w

  h=(int) max(size1 , y_offset +size2); //compute the max of size1 and (y_offset + size2).  Call this h
